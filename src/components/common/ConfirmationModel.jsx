...
export default function ConfirmationModel({ modalData }) {
    return (
        <div className="fixed border border-caribbeangreen-400 inset-0 z-[1000] !mt-0 grid place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm">
