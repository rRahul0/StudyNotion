...
import {editCourseDetailsAPI} from '../../../../../services/operations/CourseDetailsAPI'
...
const PublishCourse = () => {
  ...
  const handleCoursePublish = async() => {
    if ((course?.status === COURSE_STATUS.PUBLISH && getValues("public") === true) || (course?.status === COURSE_STATUS.DRAFT && getValues("public") === false)) {
      goToCourses()
      return
    }
